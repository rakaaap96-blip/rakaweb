          ...
          >
            ...
            >
              <div className="flex justify-between items-start mb-4">
                <div className="w-10 h-10 bg-primary-100 border-2 border-black flex items-center justify-center text-primary-600 group-hover:scale-110 transition-transform duration-200" aria-hidden="true">
                  <Sparkles size={20} />
                </div>
                <div className="w-8 h-8 bg-black text-white border-2 border-black flex items-center justify-center font-black text-sm group-hover:bg-yellow-300 group-hover:text-black transition-colors" aria-label="Fitur nomor 1">
                  01
                </div>
              </div>
              <div>
            ...
            >
              <div className="flex justify-between items-start mb-6">
                <div className="w-10 h-10 bg-primary-100 border-2 border-black flex items-center justify-center text-green-600 group-hover:scale-110 transition-transform" aria-hidden="true">
                  <CheckCircle size={20} />
                </div>
            ...
            >
              <div className="flex justify-between items-start mb-6">
                <div className="w-10 h-10 bg-primary-100 border-2 border-black flex items-center justify-center text-blue-600 group-hover:scale-110 transition-transform" aria-hidden="true">
                  <Shield size={20} />
                </div>
                <ArrowDownRight size={20} className="text-navy-400 group-hover:translate-x-1 group-hover:translate-y-1 transition-transform" aria-hidden="true" />
              </div>
            ...
            >
              <div className="flex items-center gap-4">
                <div className="w-12 h-12 bg-primary-100 border-2 border-black flex items-center justify-center text-purple-600 shrink-0 group-hover:scale-110 transition-transform" aria-hidden="true">
                  <TrendingUp size={24} />
                </div>
                <div>
              ...
              <div className="px-3 py-1.5 bg-black text-white text-xs font-mono font-black uppercase tracking-wider shrink-0 border border-black max-sm:w-full text-center group-hover:bg-yellow-300 group-hover:text-black transition-colors" aria-label="Keunggulan: Target Pasar Tepat">
                Target Pasar Tepat
              </div>
